...
function boardColumns(): Column<Pick>[] {
  return [
    ...
    },
    {
      ...
      align: 'right',
      width: '6rem',
      help: "PFR's own record of his last season played, from the draft file — not our 1999 stat window.",
    ...
    },
    {
      ...
      header: 'G',
      align: 'right',
      help: 'Career games, as PFR recorded his full career — not our 1999 stat window.',
    ...
    },
    {
      ...
      header: 'GS Seasons',
      align: 'right',
      help: 'Seasons PFR credits him with starting.',
      optional: true,
    ...
    },
    {
      ...
      align: 'right',
      optional: true,
      help: "The same player's Approximate Value earned with the club that drafted him.",
